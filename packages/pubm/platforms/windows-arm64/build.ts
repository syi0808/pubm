...
await $`bun install @napi-rs/keyring-win32-arm64-msvc@1.2.0 --os='win32' --cpu='arm64'`;
...
const result = await Bun.build({
  ...
  plugins: [
    createKeyringPlugin(
      ROOT,
      "./node_modules/@napi-rs/keyring-win32-arm64-msvc/keyring.win32-arm64-msvc.node",
    ),
  ],
  define,
});
