...
describe("prompt display colors", () => {
  it("renders recommendations as grouped package summaries", () => {
    ...
    expect(summary).toContain(
      '  packages/core\n    bump: minor    source: changeset\n    detail: "Add release automation" (+1 more)',
    );
    expect(summary).toContain(
      "  packages/pubm\n    bump: patch    source: commit\n    detail: fix: npm login",
    );
    expect(summary).toContain("2 packages to bump");
    expect(summary).not.toContain("Source      Package");
