...
Erstellt einen Pull Request für den Version-Bump-Commit anstatt direkt in den Basis-Branch zu pushen. Das ist eine bestehende Config-Oberfläche für geschützte Versions-Pushes, keine empfohlene Wahl des Release-Workflows. Wähle zwischen Direct Release und Split CI Release in [Release-Workflows](/pubm/de/guides/release-workflows/).

Kann auch als Fallback gesetzt werden: pubm fällt automatisch in den PR-Modus zurück, wenn ein direkter Push auf einen geschützten Branch fehlschlägt.
