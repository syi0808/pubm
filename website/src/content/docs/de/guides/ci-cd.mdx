...
Verwende die GitHub Action [`syi0808/pubm/actions/changeset-check`](https://github.com/syi0808/pubm/tree/main/actions/changeset-check), um sicherzustellen, dass jeder PR ein Changeset enthält. `pubm init` generiert diesen Workflow automatisch, wenn Changesets aktiviert sind.
