...
description: Binärdateien, Archive und Installer mit automatischer Plattform-Erkennung und Komprimierung an GitHub Releases anhängen.
---
...
Wenn Capture-Variablen vorhanden sind, verwendet `pubm` sie direkt, statt jedes Pfadsegment gegen die Plattformtabellen zu scannen. Siehe [Platform Detection](/pubm/de/reference/platform-detection/) für den vollständigen Parsing-Algorithmus.
...
- Lies [Platform Detection](/pubm/de/reference/platform-detection/) für die vollständigen OS-, Architektur-, ABI- und Variantentabellen.
- Lies [Asset Pipeline Hooks](/pubm/de/guides/asset-pipeline-hooks/), um jede Stufe der Pipeline abzufangen und anzupassen.
- Lies [Official Plugins](/pubm/de/reference/official-plugins/), um zu sehen, wie das Brew-Plugin `ParsedPlatform` für das Matching von Formulae nutzt.
