...
`@pubm/plugin-brew` hilft CLI-Projekten dabei, Homebrew-Formulae mit jedem Release synchron zu halten. Registriert Rollback-Aktionen, um erstellte Homebrew-PRs zu schliessen, falls die Pipeline nach der PR-Erstellung fehlschlaegt.
