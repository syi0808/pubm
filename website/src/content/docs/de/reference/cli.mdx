---
title: CLI-Referenz
description: "Befehle, Flags und Release-Ablaeufe für die `pubm`-CLI."
---
...
Die Publish-Phase veröffentlicht vom neuesten Git-Tag und erstellt einen GitHub Release über die API. Verwende sie, wenn Versionssprung und Tagging vorher schon in der Pipeline passiert sind. Mit `--release-draft` erstellst du statt eines veröffentlichten Releases einen Draft.
