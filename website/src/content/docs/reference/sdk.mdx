...
| `PluginCredential` | type | Declarative descriptor for a token or secret required by a plugin. See [Plugins API Reference](/pubm/reference/plugins/#plugincredential). |
| `PluginCheck` | type | Descriptor for a preflight check contributed by a plugin. See [Plugins API Reference](/pubm/reference/plugins/#plugincheck). |
