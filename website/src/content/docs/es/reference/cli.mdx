...
description: Comandos, flags y flujos de release para el CLI de pubm.
---
...
La fase de publicación publica desde el último Git tag y crea un GitHub Release mediante la API. Úsala cuando el bump de versión y el tagging ya hayan ocurrido antes en el pipeline. Pasa `--release-draft` para crear un release en borrador en lugar de uno publicado.
