...
`pubm --phase prepare` es una preparación real de Split CI Release: puede escribir versiones, crear tags y hacer push del commit de release y los tags. Úsalo solo cuando quieras preparar una publicación en CI, no como una comprobación sin efectos secundarios.
