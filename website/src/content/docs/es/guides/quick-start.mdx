...
`pubm` es un orquestador de releases para proyectos que publican en más de un registry, más de un paquete o más de un ecosistema.
...
- Alternativamente, usa la skill `publish-setup` del bundle `pubm plugin` para instalar el workflow de release, generar la configuración, conectar CI y activar changesets.
