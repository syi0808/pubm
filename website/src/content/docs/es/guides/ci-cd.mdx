...
Usa la GitHub Action [`syi0808/pubm/actions/changeset-check`](https://github.com/syi0808/pubm/tree/main/actions/changeset-check) para exigir que cada PR incluya un changeset. `pubm init` genera este workflow automáticamente cuando los changesets están habilitados.
