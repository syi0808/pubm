---
title: CLI 参考
description: pubm CLI 的命令、flags 和 release 流程。
---
...
Publish 阶段会从最新的 Git tag 发布，并通过 API 创建 GitHub Release。适合版本 bump 和打 tag 已经在流水线更早阶段完成的场景。传入 `--release-draft` 可以创建草稿 release，而不是正式发布。
