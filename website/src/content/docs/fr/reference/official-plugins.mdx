...
`@pubm/plugin-brew` aide les projets CLI à maintenir les formules Homebrew synchronisées avec chaque release.
...
Ce plugin garde les fichiers hors manifest alignés sur la version de votre package.
