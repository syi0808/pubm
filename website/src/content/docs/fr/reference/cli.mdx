...
4. **Configuration du workflow** : propose d'activer le workflow de changesets (crée `.pubm/changesets/`, `.github/workflows/pubm-changeset-check.yml` et met à jour `.gitignore`) et de générer les workflows de release CI (`.github/workflows/pubm-release-pr.yml` and `.github/workflows/pubm-publish.yml`).
