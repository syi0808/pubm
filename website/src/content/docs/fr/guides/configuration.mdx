...
Crée une pull request pour le commit de version bump au lieu de pousser directement vers la branche de base. C'est une surface de config existante pour les pushes de version protégés, pas un choix de workflow de release recommandé. Choisissez entre Direct Release et Split CI Release dans [Workflows de release](/pubm/fr/guides/release-workflows/).

Peut aussi servir de repli : pubm revient automatiquement au mode PR lorsqu'un push direct vers une branche protégée échoue.
