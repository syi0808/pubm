...
Utilisez l'action GitHub [`syi0808/pubm/actions/changeset-check`](https://github.com/syi0808/pubm/tree/main/actions/changeset-check) pour exiger que chaque PR inclue un changeset. `pubm init` génère ce workflow automatiquement lorsque les changesets sont activés.
