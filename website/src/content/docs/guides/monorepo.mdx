...
In a monorepo, the important difference is not the command shape but the release plan that `pubm` calculates from pending changesets, conventional commits, package groups, and dependency order.
