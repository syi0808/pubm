...
Create a pull request for the version bump commit instead of pushing directly to the base branch. This is existing config surface for guarded version pushes, not a recommended release workflow choice. Choose between Direct Release and Split CI Release in [Release Workflows](/pubm/guides/release-workflows/).
...
- See the [Changesets](/pubm/guides/changesets/) guide for more on the conventional commit fallback behavior.
