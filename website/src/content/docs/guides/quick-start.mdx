...
If pending changesets exist, `pubm` consumes them during the version step of the release pipeline. For config details, read [Configuration](/pubm/guides/configuration/). For CI, tokens, and preparation behavior, read [CI/CD](/pubm/guides/ci-cd/). For monorepos, read [Monorepo](/pubm/guides/monorepo/). For exact flags and subcommands, read the [CLI Reference](/pubm/reference/cli/).
