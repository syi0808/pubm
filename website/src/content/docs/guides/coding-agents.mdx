...
This downloads the skill bundle for your agent (Claude Code, Codex CLI, or Gemini CLI) from the pubm GitHub repository and places it in the correct directory. It is also available as the final step of `pubm init`.

## Start with setup automation

If a repository is not wired yet, the most important agent action is not publish. It is setup.
...
If you are not using a marketplace, provide the agent with the [INSTALLATION.md](/pubm/plugins/pubm-plugin/INSTALLATION.md) link instead.
