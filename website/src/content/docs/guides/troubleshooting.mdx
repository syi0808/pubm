    ...
    content: |
      {
        ...
        "mainEntity": [
          ...
          },
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "CI disables prompts and tokens must come from environment variables. Run pubm --mode ci --phase prepare locally to simulate, use full Git history in CI, and confirm every required token is present."
            }
          },
          {
            "@type": "Question",
