...
Branch, Working Tree, Remote-Sync, Login-Status und Publish-Berechtigungen werden **bevor** pubm etwas aendert geprueft. Du kannst auch deine gesamte CI-Pipeline lokal dry-runnen:
